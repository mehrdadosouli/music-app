...
function Header() {
  ...
  return (
    <div className={`flex justify-between items-center fixed top-10 ${scrollY && 'backdrop-blur-xl'}`}>
      ...
      <Menu />
      <SearchHeader />
      <button className='text-primarytxt' onClick={clickHandler}>{theme == "light" ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="size-6">
