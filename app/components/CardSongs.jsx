...
export default function CardSongs({ song, h = "15rem", w = "100%", rounded = "0", bg = "bgcard", txt = "start" }) {
    return (
        <Link to={`/album/${song.albumId}`} data-aos="flip-right" data-aos-offset="100" className={`flex flex-col bg-${bg} gap-3 hover:shadow-lg transition-all duration-300 hover:scale-105 z-0`}>
