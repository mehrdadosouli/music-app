        ...
        <div className="flex items-start">
            ...
            <div className="w-4/6 relative z-10 ">
                <div className="border-slate-100 transition-all duration-500 border-b rounded-t-xl p-4 pb-6 ">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-between text-sm leading-6 font-medium tabular-nums">
                            <div className="text-cyan-500 transition-all duration-500">24:16</div>
                ...
                <div className=" text-white transition-all duration-500 rounded-b-xl flex items-center">
                    ...
                    <button type="button" className="bg-white text-slate-900 transition-all duration-500 flex-none -my-2 mx-auto w-20 h-20 rounded-full ring-1 ring-slate-900/5 shadow-md flex items-center justify-center" aria-label="Pause">
