...
function Menu() {    
    ...
    return (
        <div className="w-full lg:static fixed bottom-0 left-0 right-0 mx-auto flex justify-center items-center z-[103] lg:bg-transparent bg-bgcard py-2 gap-5 lg:mx-5 ">
