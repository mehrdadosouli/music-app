...
export default function CardTopSongs({ song }) {
    return (
        <Link to={`/album/${song.albumId}`} className="flex flex-col bg-bgcard rounded-xl gap-3 overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-105">
